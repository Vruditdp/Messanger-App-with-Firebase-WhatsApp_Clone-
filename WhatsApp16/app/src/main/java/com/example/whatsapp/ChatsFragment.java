...
public class ChatsFragment extends Fragment
{
    ...
    private DatabaseReference ChatsRef, UsersRef,LastmsgRef;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LastmsgRef = FirebaseDatabase.getInstance().getReference();
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot)
                            {
                                if (dataSnapshot.exists())
                                {
                                    if (dataSnapshot.hasChild("image"))
                                    {
                                        ...
                                        Picasso.get().load(retImage[0]).networkPolicy(NetworkPolicy.OFFLINE).into(holder.profileImage, new Callback() {
                                            @Override
