                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                holder.AcceptButton.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        builder.setTitle("Are you really want to Accept " + requestUserName + "'s Chat Request");
                                                ...
                                                holder.CancelButton.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                                                        builder.setTitle("Are you really want to Cancel " + requestUserName + "'s Chat Request");
...
//                                                });
                                                ...
                                                holder.CancelButton.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View view) {
                                                        ...
                                                        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                                                        builder.setTitle("Are you really want to Cancel  Chat Request to " + requestUserName );
